(function ($) {
  ...
  if ($.fn && typeof $.fn.datepicker === "function" && $("#datepicker").length) {
    $("#datepicker").datepicker();
  }

  if ($.fn && typeof $.fn.datepicker === "function" && $("#datepicker2").length) {
  ...
  if (
    $.fn &&
    typeof $.fn.ptTimeSelect === "function" &&
  ...
  if ($(".banner-bg-slide").length) {
    $(".banner-bg-slide").each(function () {
      ...
      if ($.fn && typeof $.fn.vegas === "function") {
  ...
  if (
    $.fn &&
    typeof $.fn.niceSelect === "function" &&
    $('select:not(.ignore)').length
  ) {
